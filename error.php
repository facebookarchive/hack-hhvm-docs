...
// First try a full manual/en redirect in case we are coming from
// a URL like docs.hhvm.com/introduction.php
if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/manual/$LANG/$URI")) {
    mirror_redirect("/manual/$LANG/$URI");
}
